...
.controller('StarterCtrl', function($scope) {
  ...
  var paymentPreferenceIos = "{\"excludedPaymentMethodIds\":\"amex,visa\",\"maxAcceptedInstallments\":3,\"defaultPaymentTypeId\":null,\"defaultPaymentMethodId\":null,\"defaultInstallments\":null,\"excludedPaymentTypeIds\":\"ticket\"}";
 ...
 $scope.startPaymentVault = function() {
    MercadoPago.showPaymentVault(publicKey, "Argentina", 200, $scope.myStyle.color, $scope.blackFont, paymentPreferenceIos, success, failure);
 };
 ...
 $scope.showIssuers = function(){
  MercadoPago.showIssuers(publicKey, "visa", $scope.myStyle.color, $scope.blackFont, null,  success, failure);
 }
 $scope.showInstallments = function(){
  MercadoPago.showInstallments(publicKey, "Argentina", 200, "visa", "326", $scope.myStyle.color, $scope.blackFont, paymentPreferenceIos, success, failure);
 }
 ...
 $scope.showPaymentResult = function(){
  MercadoPago.showPaymentResult(publicKey, payment, "ticket", success, failure);
 }
