...
.controller('StarterCtrl', function($scope) {
 ...
 $scope.startPaymentVault = function() {
    MercadoPago.showPaymentVault(publicKey, "Argentina", 200, $scope.myStyle.color, $scope.blackFont, paymentPreferenceIos
      , success, failure);
 };
 ...
 $scope.showPaymentMethods = function(){
  MercadoPago.showPaymentMethods(publicKey, $scope.myStyle.color, $scope.blackFont, paymentPreferenceIos, success, failure);
 }
