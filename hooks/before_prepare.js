...
module.exports = function(context) {
    ...
    child_process.exec("npm --prefix " + pluginDir + " install " + pluginDir, function(){
      ...
      xcodeProject.parse(function(err) {
          ...
          var frameworkPath = cfg.name() + "/Plugins/com.mercadopago.cordova.sdk/";
          xcodeProject.removeFramework(frameworkPath + "MercadoPagoSDK.framework", {customFramework: true, embed: true, link: true});
          ...
          xcodeProject.addFramework(frameworkPath + "MercadoPagoSDK.framework", {customFramework: true, embed: true, link: true});
